...
var Combobox = /*#__PURE__*/function (_Component) {
  ...
  _createClass(Combobox, [{
    ...
    key: "getChoicesSelect",
    value: function getChoicesSelect(choice) {
      var _this4 = this;

      var _this$props4 = this.props,
          prefixCls = _this$props4.prefixCls,
          choiceOptions = _this$props4.choiceOptions,
      ...
      return /*#__PURE__*/_react.default.createElement(_Select.default, {
        prefixCls: prefixCls,
        options: choiceOptions.map(function (option) {
          return formatOption(option, disabledOptions);
        }),
        ...
        onSelect: this.onItemChange,
        onMouseEnter: function onMouseEnter() {
          return _this4.onEnterSelectPanel('choice');
        },
        onEsc: onEsc
      });
    }
    ...
    value: function getSecondSelect(second) {
      ...
      return /*#__PURE__*/_react.default.createElement(_Select.default, {
        ...
        onSelect: this.onItemChange,
        onMouseEnter: function onMouseEnter() {
          return _this5.onEnterSelectPanel('second');
        },
        onEsc: onEsc
      });
    }
    ...
    value: function getAMPMSelect() {
      ...
      return /*#__PURE__*/_react.default.createElement(_Select.default, {
        ...
        onSelect: this.onItemChange,
        onMouseEnter: function onMouseEnter() {
          return _this6.onEnterSelectPanel('ampm');
        },
        onEsc: onEsc
      });
    }
    ...
    value: function render() {
      ...
      }, this.getHourSelect(value.hour()), this.getMinuteSelect(value.minute()), this.getSecondSelect(value.second()), this.getChoicesSelect(value.minute()), this.getAMPMSelect(value.hour()));
    }
  }]);
